...
toolbox.router.get("/*", toolbox.cacheFirst, {"origin":"www.030706.xyz"});
toolbox.router.get("/npm/*", toolbox.cacheFirst, {"origin":"blog.sunnyduskxi.workers.dev"});
